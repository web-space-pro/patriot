<?php
add_action('after_setup_theme', 'patriot_theme_register_nav_menu');
add_filter('walker_nav_menu_start_el', 'patriot_theme_add_caret_to_menu', 10, 4);
add_filter('wp_nav_menu_args', 'my_wp_nav_menu_args');

function patriot_theme_register_nav_menu()
{
...
function patriot_theme_add_caret_to_menu($item_output, $item, $depth, $args) {
